...
class ProjectCreate extends Component {
	...
	validate = () => {
		...
		if (!this.state.projectDescription)
			errors.projectDescription = "Can't be blank"
		...
		if (!this.state.projectCompletionDate)
			errors.projectCompletionDate = "Can't be blank"
						...
						<Segment stacked>
							...
							<Form.Field error={!!errors.projectValuation}>
								...
								<input
									...
									onChange={e =>
										this.setState({ projectValuation: e.target.value })
									}
								/>
							</Form.Field>
							<Divider />
							...
							<Form.Field error={!!errors.projectCompletionDate}>
								...
								<DatePicker
									selected={this.state.projectCompletionDate}
...
export default graphql(CREATEPROJECTMUTATION, { name: 'createProject' })(
	ProjectCreate,
)
