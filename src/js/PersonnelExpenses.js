    ...
    return (
      <Segment>
        <Grid columns={2} relaxed>
          ...
          <Grid.Column>
            <b>{currencyFormatter.format(this.props.totalsFeed.SALARYREQUESTS, { code: 'KES' })}</b>
            <Divider />
            <b>{currencyFormatter.format(this.props.totalsFeed.ADVANCEREQUESTS, { code: 'KES' })}</b>
            <Divider />
            <b>{currencyFormatter.format(this.props.totalsFeed.OVERTIMEREQUESTS, { code: 'KES' })}</b>
            <Divider />
          </Grid.Column>
        </Grid>
