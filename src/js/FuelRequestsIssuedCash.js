    ...
    return (
      <React.Fragment>
        ...
        <Table celled selectable>
          ...
          <Table.Body>
            {this.props.requisitionFeed.issuedFuelRequisitionsFeed.map(request => {
              if (request.requestedFuelPayment !== null && request.paymentsDetails !== null) {
                return (
                  <Table.Row>
                    ...
                    <Table.Cell>
                      {(() => {
                        if (this.props.userDetails.me.role === 'ACCOUNTANT') {
                          return (
                            <Link to={`/fuelrequisitions/report/${request.id}`}>
                              Report Cash Usage
