...
class OverTimeApproved extends Component {
	...
	render() {
		...
		if (
			this.props.requisitionFeed.approvedOverTimeRequestFeed === undefined ||
			this.props.requisitionFeed.approvedOverTimeRequestFeed === 0
		) {
		...
		return (
			<Fragment>
				...
				<Table celled selectable>
					...
					<Table.Body />
					{this.props.requisitionFeed.approvedOverTimeRequestFeed.map(
						request => (
							<Table.Row>
								<Table.Cell>
