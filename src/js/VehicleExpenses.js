    ...
    render() { 
       ...
       if (this.props.totalsFeed.REPAIRSTOTALS !== undefined){
        ...
        <Grid columns={2} relaxed >
            ...
            <Grid.Column>
                <b>{currencyFormatter.format(this.props.totalsFeed.REPAIRSREQUESTS, { code: 'KES' })}</b>
                <Divider/>
                <b>{currencyFormatter.format(this.props.totalsFeed.INSPECTIONREQUESTS, { code: 'KES' })}</b>
                <Divider/> 
                <b>{currencyFormatter.format(this.props.totalsFeed.SERVICEREQUESTS, { code: 'KES' })}</b>
                <Divider/>
                <b>{currencyFormatter.format(this.props.totalsFeed.FUELREQUESTS, { code: 'KES' })}</b>
                <Divider/>
            </Grid.Column>  
            </Grid>
            ...
            {  (this.props.startDate && this.props.endDate) && 
                ...
                <div class="ui segments">
                    ...
                    <div class="ui secondary segment">
                        <LineChart data={inspectionsdata} legend={true} width="800px" height="500px" colors={["#008080", "#008080"]} xtitle="Time" ytitle="Amount in KES"/>
                    </div>
                ...
                <div class="ui segments">
                    ...
                    <div class="ui secondary segment">
                    <LineChart data={fueldata} legend={true} width="800px" height="500px" colors={["#008080", "#008080"]} xtitle="Time" ytitle="Amount in KES"/>
                    </div>
                    <div className="ui segment">
                    <Header as='h4' dividing color="green" textAlign="center">
                        Fuel Requests 
                ...
                <div class="ui segments center">
                    ...
                    <div class="ui secondary segment">
                    <LineChart data={repairsdata} legend={true} width="800px" height="500px" colors={["#008080", "#008080"]} xtitle="Time" ytitle="Amount in KES"/>
                    </div>
                    <div className="ui segment">
                    <Header as='h4' dividing color="green" textAlign="center">
                        Repair Requests 
                ...
                <div class="ui segments">
                    ...
                    <div class="ui secondary segment">
                    <LineChart data={servicedata} legend={true} width="800px" height="500px" colors={["#008080", "#008080"]} xtitle="Time" ytitle="Amount in KES"/>
                    </div>
                    <div className="ui segment">
                    <Header as='h4' dividing color="green" textAlign="center">
                        Service Requests 
