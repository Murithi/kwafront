...
class MiscellaneousReport extends Component {
              ...
              <Table basic="very" celled>
                <Table.Body>
                  <Table.Row>
                    ...
                    <Table.Cell>
                      {initiatedMiscellaneousRequisition.requestedBy.personnelDetails.firstName} &nbsp;{' '}
                      {initiatedMiscellaneousRequisition.requestedBy.personnelDetails.lastName}
                    </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                    ...
                    <Table.Cell>KES {initiatedMiscellaneousRequisition.cashPaymentsDetails.amountIssued}</Table.Cell>
                  </Table.Row>
  ...
  _addPaymentDetails = async () => {
    ...
    await this.props.reportPaymentDetails({
      ...
      refetchQueries: [{ query: getUserDetails }, { query: getIssuedRequisitions }]
    });
