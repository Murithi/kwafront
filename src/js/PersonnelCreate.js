...
var options = [{ text: 'Male', value: true }, { text: 'Female', value: false }]

const CLOUDINARY_UPLOAD_PRESET = 'kewaeastafrica'
const CLOUDINARY_UPLOAD_URL =
	'https://api.cloudinary.com/v1_1/murithi/image/upload'
...
class PersonnelCreate extends Component {
	...
	validate = () => {
		...
		if (!this.state.highestEducationLevel)
			errors.highestEducationLevel = "Can't be blank"
		if (!this.state.certificatesUrl) errors.certificatesUrl = "Can't be blank"
		if (!this.state.curriculumVitaeUrl)
			errors.curriculumVitaeUrl = "Can't be blank"
						...
						<Segment stacked>
							...
							<Form.Field error={!!errors.highestEducationLevel}>
								...
								{errors.highestEducationLevel && (
									<InlineError text={errors.highestEducationLevel} />
								)}
							</Form.Field>
							...
							<Form.Field error={!!errors.certificatesUrl}>
								...
								{errors.certificatesUrl && (
									<InlineError text={errors.certificatesUrl} />
								)}
							</Form.Field>
							<Divider />
							...
							<Form.Field error={!!errors.curriculumVitaeUrl}>
								...
								{errors.curriculumVitaeUrl && (
									<InlineError text={errors.curriculumVitaeUrl} />
								)}
							</Form.Field>
							<Divider />
							<Form.Field error={!!errors.dateOfEmployment}>
								...
								<DatePicker
									selected={this.state.dateOfEmployment}
							...
							<Form.Field error={!!errors.dateOfTermination}>
								...
								<DatePicker
									selected={this.state.dateOfTermination}
							...
							<Form.Field error={!!errors.currentSalary}>
								...
								<input
									...
									type="number"
									onChange={e =>
										this.setState({ currentSalary: e.target.value })
									}
								/>
...
export default compose(
	graphql(Role_Feed_Query, { name: 'roleFeed' }),
	graphql(CREATEPERSONNELMUTATION, { name: 'createPersonnel' }),
)(PersonnelCreate)
