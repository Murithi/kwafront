							...
							<Table basic="very" celled>
								<Table.Body>
									<Table.Row>
										...
										<Table.Cell>
											{
												issuedMaterialRequisition.requestedBy.personnelDetails
													.firstName
											}{' '}
											&nbsp;{' '}
											{
									...
									<Table.Row>
										...
										<Table.Cell>
											KES{' '}
											{
												issuedMaterialRequisition.cashPaymentsDetails
													.amountIssued
											}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										...
										<Table.Cell>
											{issuedMaterialRequisition.materialType.materialName}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
										...
										<Table.Cell>
											{issuedMaterialRequisition.otherDetails}
										</Table.Cell>
									</Table.Row>
								</Table.Body>
							</Table>
