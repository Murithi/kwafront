				...
				{this.state.idNumber === '' ? (
					<Form>
						<Form.Group unstackable widths={2}>
							...
							<Form.Button positive secondary big right>
								Submit
							</Form.Button>
						</Form.Group>
					</Form>
					...
					<div>
						...
						<Query
							...
							variables={{ idNumber: `${this.state.idNumber}` }}
						>
							{({ loading, error, data }) => {
								console.log(data)
													...
													<Segment>
														...
														<p>
															...
															{personnel.dateOfTermination
																? moment(personnel.dateOfTermination).format(
																		'MMM Do YYYY',
																  )
																: 'N/A'}
														</p>
														...
														<p>
															...
															{personnel.highestEducationLevel}
														</p>
														<Divider />
														<p>
															...
															<Image
																src={personnel.curriculumVitaeUrl}
																size="medium"
																centered
															/>
														</p>
