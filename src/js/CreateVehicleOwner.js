...
const CREATEVEHICLEOWNERMUTATION = gql`
  mutation createVehicleOwner($name: String!, $phone: String!, $email: String!) {
    addVehicleOwner(name: $name, phone: $phone, email: $email) 
  }
`;
export default graphql(CREATEVEHICLEOWNERMUTATION, { name: 'createVehicleOwner' })(withRouter(CreateVehicleOwner));
