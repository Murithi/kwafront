...
class StoreReciepts extends Component {
	...
	validate = () => {
		...
		if (!this.state.materialsRecievedFrom)
			errors.materialsRecievedFrom = "Can't be blank"
					...
					<Form size="large" onSubmit={this.onSubmit} loading={loading}>
						...
						<Segment stacked>
							...
							<Form.Field error={!!errors.materialsRecievedFrom}>
								...
								/>
								{errors.materialsRecievedFrom && (
									<InlineError text={errors.materialsRecievedFrom} />
								)}
							</Form.Field>
							<Form.Field error={!!errors.unitsRecieved}>
								...
								<input
									...
									type="number"
									onChange={e =>
										this.setState({ unitsRecieved: e.target.value })
									}
								/>
								{errors.unitsRecieved && (
									<InlineError text={errors.unitsRecieved} />
								)}
							</Form.Field>
							<Form.Field error={!!errors.deliveryNote}>
								...
								/>
								{errors.deliveryNote && (
									<InlineError text={errors.deliveryNote} />
								)}
							</Form.Field>
