...
class PersonnelRolesCreate extends Component {
						...
						<Segment stacked>
							...
							<Form.Field error={!!errors.minimumSalary}>
								...
								<input
									...
									onChange={e =>
										this.setState({ minimumSalary: e.target.value })
									}
								/>
							</Form.Field>
							...
							<Form.Field error={!!errors.maximumSalary}>
								...
								<input
									...
									onChange={e =>
										this.setState({ maximumSalary: e.target.value })
									}
								/>
							</Form.Field>
	...
	_createRole = async () => {
		const { roleName, minimumSalary, maximumSalary } = this.state
...
export default graphql(CREATEROLEMUTATION, { name: 'createRole' })(
	PersonnelRolesCreate,
)
