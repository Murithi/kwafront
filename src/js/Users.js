...
class Users extends Component {
	...
	render() {
		...
		if (this.props.userFeed.loading)
			return <React.Fragment>{loadingMessage} </React.Fragment>
		if (this.props.userFeed.error)
			return <React.Fragment>{timeoutMessage} </React.Fragment>

		if (_.isEmpty(this.props.userFeed.userFeed))
			return <React.Fragment>{emptyMessage} </React.Fragment>
		return (
			<Grid
				textAlign="center"
				style={{ height: '100%' }}
