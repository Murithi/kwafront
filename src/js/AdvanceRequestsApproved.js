...
class AdvanceRequestsApproved extends Component {
	...
	render() {
		...
		if (
			this.props.requisitionFeed.approvedAdvanceRequestFeed === undefined ||
			this.props.requisitionFeed.approvedAdvanceRequestFeed === 0
		) {
		...
		return (
			<Fragment>
				...
				<Table celled selectable>
					...
					<Table.Body />
					{this.props.requisitionFeed.approvedAdvanceRequestFeed.map(
						request => {
							return (
								<Table.Row>
									<Table.Cell>
