...
class MiscellaneousApproved extends Component {
    ...
    render() { 
        ...
        if (this.props.requisitionFeed && this.props.requisitionFeed.loading) {
          ...
          if (this.props.requisitionFeed.approvedMiscellaneousRequisitionFeed === undefined ||this.props.requisitionFeed.approvedMiscellaneousRequisitionFeed === 0) {
        ...
        return ( 
            ...
            <Table celled selectable>
                ...
                {
                    this.props.requisitionFeed.approvedMiscellaneousRequisitionFeed.map(request => {
