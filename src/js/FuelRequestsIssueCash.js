...
class FuelRequestsIssueCash extends Component {
          ...
          <Segment.Group horizontal>
            <Segment>
              ...
              <Table basic="very" celled>
                <Table.Body>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>{initiatedFuelRequisition.vehicleToBeFueled.registrationNumber}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Requested By</b>
                    ...
                    <Table.Cell>
                      {initiatedFuelRequisition.requestedBy.personnelDetails.firstName} &nbsp;{' '}
                      {initiatedFuelRequisition.requestedBy.personnelDetails.lastName}
                    </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>{initiatedFuelRequisition.approxCostOfFuel}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Date Requested </b>
                    </Table.Cell>
                    <Table.Cell>{moment(initiatedFuelRequisition.requestDate).format('MMM Do YYYY')} </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Date Approved </b>
                    </Table.Cell>
                    <Table.Cell>{moment(initiatedFuelRequisition.approvalDate).format('MMM Do YYYY')} </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Other Details </b>
                    </Table.Cell>
                    <Table.Cell>{initiatedFuelRequisition.otherDetails}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Amount Issuing</b>
              ...
              <Button
                attached="bottom"
                positive
                onClick={() => this._issueCash(initiatedFuelRequisition.id, initiatedFuelRequisition.approxCostOfFuel)}
              >
                Issue Cash
              </Button>
            </Segment>
  ...
  _issueCash = async (requestId, amountIssued) => {
    ...
    await this.props.issuePayment({
      ...
      refetchQueries: [{ query: getApprovedRequisitions }, { query: getUserDetails }]
    });
