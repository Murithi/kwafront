...
class VehicleInspectionRequisitions extends Component {
	constructor(props) {
		super(props)
		this.state = {}
	}
	render() {
		if (this.props.inspectiondetail.loading) {
			return <div>{loadingMessage}</div>
		}
		if (this.props.inspectiondetail.loading) {
			return <div>{timeoutMessage}</div>
		}
		console.log(this.props.inspectiondetail)
		const { getVehicle } = this.props.inspectiondetail
...
const GETINSPECTIONDETAILS = gql`
...
export default graphql(GETINSPECTIONDETAILS, {
