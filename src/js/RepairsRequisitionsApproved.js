...
class RepairsRequisitionsApproved extends Component {
    ...
    render() { 
        ...
        if (this.props.requisitionFeed && this.props.requisitionFeed.loading) {
          ...
          if (this.props.requisitionFeed.approvedRepairsRequisitionsFeed === undefined ||this.props.requisitionFeed.approvedRepairsRequisitionsFeed === 0) {
        ...
        return ( 
            <React.Fragment>
                ...
                <Table celled selectable>
                    ...
                    {
                        this.props.requisitionFeed.approvedRepairsRequisitionsFeed.map(request => {
                                ...
                                <Table.Cell>
                                    {(() => {
                                        ...
                                        if (this.props.userDetails.me.role === 'ACCOUNTANT') {
                                            return (
                                                <Link to={`/repairsrequisitions/issue/${request.id}`}>
                                                    Issue Cash
