...
class StoreIssues extends Component {
    ...
    validate = () => {
        ...
        if (!this.state.materialsIssuedTo) errors.materialsIssuedTo = "Can't be blank"
                ...
                {errors.global && (
                    ...
                    <Form.Field error={!!errors.itemId}>
                        ...
                        <Form.Field error={!!errors.materialsIssuedTo}>
                            ...
                            />
                            {errors.materialsIssuedTo && <InlineError text={errors.materialsIssuedTo} />}
                        </Form.Field>
                        <Form.Field error={!!errors.unitsIssued}>
                            ...
                            />
                            {errors.unitsIssued && <InlineError text={errors.unitsIssued} />}
                        </Form.Field>
    ...
    _addIssue = async () => {
        const { itemId,  unitsIssued,
            dateOfTran, materialsIssuedTo,
             } = this.state
...
mutation issueMaterial(
  ...
  $StoreBalId:ID!, $transactionDate:String!, $projectId:ID!
