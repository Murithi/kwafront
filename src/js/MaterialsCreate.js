...
class MaterialsCreate extends Component {
	...
	validate = () => {
		...
		if (!this.state.materialDescription)
			errors.materialDescription = "Can't be blank"
					...
					<Form size="large" onSubmit={this.onSubmit} loading={loading}>
						...
						<Segment stacked>
							<Form.Field error={!!errors.materialName}>
								...
								/>
								{errors.materialName && (
									<InlineError text={errors.materialName} />
								)}
							</Form.Field>
							<Form.Field error={!!errors.materialDescription}>
								...
								<input
									...
									onChange={e =>
										this.setState({ materialDescription: e.target.value })
									}
								/>
								{errors.materialDescription && (
									<InlineError text={errors.materialDescription} />
								)}
							</Form.Field>
							<Form.Field error={!!errors.standardUnit}>
								...
								<input
									...
									onChange={e =>
										this.setState({ standardUnit: e.target.value })
									}
								/>
								{errors.standardUnit && (
									<InlineError text={errors.standardUnit} />
								)}
							</Form.Field>
							...
							<Form.Field error={!!errors.costPerUnit}>
								...
								/>
								{errors.costPerUnit && (
									<InlineError text={errors.costPerUnit} />
								)}
							</Form.Field>
...
export default graphql(CREATEMATERIALSMUTATION, { name: 'createMaterials' })(
	MaterialsCreate,
)
