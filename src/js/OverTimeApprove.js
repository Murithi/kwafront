    ...
    render() { 
        ...
        <Grid.Column style={{ maxWidth: 900 }}>
            ...
            <Segment.Group horizontal>
                <Segment>   
                <p>
                    <b>Employee Seeking Over Time:</b> {initiatedOverTimeRequest.payee.firstName} &nbsp; {initiatedOverTimeRequest.payee.lastName} 
                </p>
                <Divider/>
                <p>
                    <b>Amount Requested:</b> {initiatedOverTimeRequest.amountRequested}
                </p>          
                <Divider/>
                <p>
                ...
                <Divider/> 
                <p>
                <b>Requested By:</b> {initiatedOverTimeRequest.requestedBy.personnelDetails.firstName} &nbsp; {initiatedOverTimeRequest.requestedBy.personnelDetails.lastName}
                </p>          
                <Divider/> 
                <p>
                <b>Requested On:</b> {moment(initiatedOverTimeRequest.requestDate).format('MMM Do YYYY')} 
                </p>          
                <Divider/> 
                <p>
                        <b>Approved On:</b>  <DatePicker selected={this.state.approvalDate} onChange={this.handleApprovalDateChange} />
                </p> 
                <Divider/>     
                        <Button
                            attached='bottom'
...
mutation approveoverTimeRequest($overtimerequestId:ID! $approvalDate:String!) {
    approveOverTimeRequest(
        overtimerequestId:$overtimerequestId, approvalDate:$approvalDate)
}`
