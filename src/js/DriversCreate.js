...
class DriversAdd extends Component {
	...
	render() {
		...
		if (this.props.personnelFeed.loading === false) {
			if (
				this.props.personnelFeed.personnelRoleFeedByDesignation[0]
					.personnels !== undefined ||
				this.props.personnelFeed.personnelRoleFeedByDesignation[0]
					.personnels !== null
			) {
				let tempOps = this.props.personnelFeed.personnelRoleFeedByDesignation[0]
					.personnels
				personnelOptions = []
				tempOps.map(element => {
					...
					<Form size="large" onSubmit={this.onSubmit} loading={loading}>
						...
						<Segment stacked>
							...
							<Form.Field>
								...
								<DatePicker
									selected={this.state.licenseExpiry}
