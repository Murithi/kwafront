							...
							<Table basic="very" celled>
								<Table.Body>
									<Table.Row>
										...
										<Table.Cell>
											{issuedRequisition.requestedBy.personnelDetails.firstName}{' '}
											&nbsp;{' '}
											{issuedRequisition.requestedBy.personnelDetails.lastName}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
										...
										<Table.Cell>
											KES {issuedRequisition.paymentsDetails.amountIssued}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
										...
										<Table.Cell>
											{issuedRequisition.vehicleToBeServiced.registrationNumber}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
