...
class ServiceRequisitionsList extends Component {
    ...
    render() { 
            ...
            const loadingMessage = (
              ...
              if (this.props.ServiceRequisitionFeed.requestServiceFeed === undefined ||this.props.ServiceRequisitionFeed.requestServiceFeed=== 0) {
...
export default
  graphql(Service_Requisition_Feed_Query,
    { name: 'ServiceRequisitionFeed' })(ServiceRequisitionsList);