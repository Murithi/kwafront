								...
								<Form size="mini" onSubmit={this.onSubmit}>
									...
									<Segment>
										...
										<Form.Field error={!!errors.inAttendance}>
											...
											<Checkbox
												label="Present"
												onChange={this.handleInAttendance}
											/>
											{errors.inAttendance && (
												<InlineError text={errors.inAttendance} />
											)}
										</Form.Field>
										<Divider />
										<Form.Field error={!!errors.dateOfAttendance}>
											...
											{errors.dateOfAttendance && (
												<InlineError text={errors.dateOfAttendance} />
											)}
										</Form.Field>
										<Divider />
										<Form.Field error={!!errors.reportingTime}>
											...
											{errors.reportingTime && (
												<InlineError text={errors.reportingTime} />
											)}
										</Form.Field>
										<Divider />
										<Form.Field error={!!errors.exitTime}>
											...
											/>
											{errors.exitTime && (
												<InlineError text={errors.exitTime} />
											)}
										</Form.Field>
									</Segment>
