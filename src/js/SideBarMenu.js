			...
			<Accordion as={Menu} vertical>
				...
				<Menu.Item>
					<Accordion.Title
						...
						content="Vehicle Repairs"
						index={5}
						onClick={this.handleClick}
					/>
					<Accordion.Content
						active={activeIndex === 5}
						content={VehicleRepairForm}
					/>
				</Menu.Item>
				...
				<Menu.Item>
					<Accordion.Title
						...
						content="Vehicle Service"
						index={6}
						onClick={this.handleClick}
					/>
					<Accordion.Content
						active={activeIndex === 6}
						content={VehicleServiceForm}
					/>
				</Menu.Item>
				...
				<Menu.Item>
					...
					<Accordion.Content
						active={activeIndex === 9}
						content={MaterialsManagementForm}
					/>
				</Menu.Item>
				...
				<Menu.Item>
					...
					<Accordion.Content
						active={activeIndex === 10}
						content={SuppliersManagementForm}
					/>
				</Menu.Item>
				...
				<Menu.Item>
					...
					<Accordion.Content
						active={activeIndex === 11}
						content={MaterialsRequisitionManagementForm}
					/>
				</Menu.Item>
				...
				<Menu.Item>
					...
					<Accordion.Content
						active={activeIndex === 13}
						content={MiscellaneousExpensesForm}
					/>
				</Menu.Item>
