...
class PersonnelTerminate extends Component {
	...
	validate = () => {
		const errors = {}
		if (!this.state.reasonsForTermination)
			errors.reasonsForTermination = "Can't be blank"
		if (!this.state.dateOfTermination)
			errors.dateOfTermination = "Can't be blank"
									...
									<Segment.Group horizontal>
										<Segment>
											...
											<p>
												...
												{moment(personnel.dateOfEmployment).format(
													'MMM Do YYYY',
												)}
											</p>
											<Divider />
										...
										<Segment stacked>
											...
											<Form.Field error={!!errors.reasonsForTermination}>
												...
												<input
													...
													onChange={e =>
														this.setState({
															reasonsForTermination: e.target.value,
														})
													}
												/>
												{errors.reasonsForTermination && (
													<InlineError text={errors.reasonsForTermination} />
												)}
											</Form.Field>
