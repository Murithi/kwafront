...
const options = [
	{
		id: 'cjf7ceyetbv7509252nkkoa6r',
		text: 'Kewa East Africa',
		value: 'Kewa East Africa',
	},
	{
		id: 'cjf80daoysywq0925tsclayt1',
		text: 'County Engineering',
		value: 'County Engineering',
	},
]
class CreateVehicle extends Component {
	...
	validate = () => {
		...
		if (!this.state.registrationNumber)
			errors.registrationNumber = "Can't be blank"
		...
		if (!this.state.insuranceRenewalDate)
			errors.insuranceRenewalDate = "Can't be blank"
						...
						<Segment stacked>
							<Form.Field error={!!errors.registrationNumber}>
								...
								{errors.registrationNumber && (
									<InlineError text={errors.registrationNumber} />
								)}
							</Form.Field>
							...
							<Form.Field error={!!errors.logBookNumber}>
								...
								<input
									...
									onChange={e =>
										this.setState({ logBookNumber: e.target.value })
									}
								/>
								{errors.logBookNumber && (
									<InlineError text={errors.logBookNumber} />
								)}
							</Form.Field>
							...
							<Form.Field error={!!errors.insuredValue}>
								...
								<input
									...
									onChange={e =>
										this.setState({ insuredValue: e.target.value })
									}
								/>
								{errors.insuredValue && (
									<InlineError text={errors.insuredValue} />
								)}
							</Form.Field>
							<Form.Field error={!!errors.insuranceRenewalDate}>
								<label>Insurance Renewal Date</label>{' '}
								<DatePicker
									selected={this.state.insuranceRenewalDate}
							...
							<Form.Field error={!!errors.manufactureDate}>
								...
								{errors.manufactureDate && (
									<InlineError text={errors.manufactureDate} />
								)}
							</Form.Field>
...
`
export default graphql(CREATEVEHICLEMUTATION, { name: 'createVehicle' })(
