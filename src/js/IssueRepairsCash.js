...
class IssueRepairsCash extends Component {
                            ...
                            <Divider />
                                <Table basic='very' celled >
                                    ...
                                    <Table.Row>
                                        ...
                                        <Table.Cell>{moment(initiatedRepairsRequisition.requestDate).format('MMM Do YYYY')} </Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
    ...
    _issueCash = async (requestId, amountIssued) => {
        ...
        await this.props.issuePayment({
            variables: { requestId, amountIssued,
                dateIssued, accountchargedId, cashbalId, 
