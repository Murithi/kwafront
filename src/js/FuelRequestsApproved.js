...
class FuelRequestsApproved extends Component {
    ...
    render() { 
        ...
        if (this.props.requisitionFeed && this.props.requisitionFeed.loading) {
          ...
          if (this.props.requisitionFeed.approvedFuelRequisitionsFeed === undefined ||this.props.requisitionFeed.approvedFuelRequisitionsFeed === 0) {
        ...
        return ( 
            <React.Fragment>
                ...
                <Table celled selectable>
                    ...
                    {
                        this.props.requisitionFeed.approvedFuelRequisitionsFeed.map(request => {
