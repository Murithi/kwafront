						...
						<Segment>
							...
							<Table basic="very" celled>
								<Table.Body>
									<Table.Row>
										...
										<Table.Cell>
											{
												getMaterialRequisition.requestedBy.personnelDetails
													.firstName
											}{' '}
											&nbsp;{' '}
											{
									...
									<Table.Row>
										...
										<Table.Cell>
											{currencyFormatter.format(
												getMaterialRequisition.approxCost,
												{ code: 'KES' },
											)}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										...
										<Table.Cell>
											{getMaterialRequisition.materialType.materialName}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
										...
										<Table.Cell>
											{getMaterialRequisition.otherDetails}
										</Table.Cell>
									</Table.Row>
								</Table.Body>
							</Table>
							...
							<Form size="large" onSubmit={this.onSubmit} loading={loading}>
								...
								<Form.Field error={!!errors.amountPaid}>
									...
									/>
									{errors.amountPaid && (
										<InlineError text={errors.amountPaid} />
									)}
								</Form.Field>
								<Form.Field error={!!errors.invoiceNumber}>
									...
									{errors.invoiceNumber && (
										<InlineError text={errors.invoiceNumber} />
									)}
								</Form.Field>
								<Form.Field error={!!errors.discountRecieved}>
									...
									<input
										...
										onChange={e =>
											this.setState({ discountRecieved: e.target.value })
										}
									/>
									{errors.discountRecieved && (
										<InlineError text={errors.discountRecieved} />
									)}
								</Form.Field>
