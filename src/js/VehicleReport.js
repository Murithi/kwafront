...
import {Header, Grid, Segment, Divider, Message, Icon, Menu} from 'semantic-ui-react'
...
class VehicleReport extends Component {
    ...
    render() { 
        ...
        if (this.props.vehicle && this.props.vehicle.loading) {
          ...
          if (this.props.vehicle.getVehicle === undefined ||this.props.vehicle.getVehicle === 0) {
        ...
        <Grid.Column>
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;KCB 201K
        <Divider/>       
        <b>VEHICLE ASSIGNED TO</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Angela Mbithe
        <Divider/> 
        <b>INSURANCE RENEWAL DATE</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{moment('May 12 2016').format('MMM Do YYYY')}
        <Divider/>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;May 10th 2018
        <Divider/> 
        <b>INSURANCE VALUATION</b>:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;12,000,000
        <Divider/>
        </Grid.Column>      
