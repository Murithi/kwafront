...
class SectionsCreate extends Component {
    ...
    validate = () => { 
        ...
        if (!this.state.sectionDescription) errors.sectionDescription = "Can't be blank";
        if (!this.state.value) errors.value = "Can't be blank";
        if (!this.state.sectionStartDate) errors.sectionStartDate = "Can't be blank";
        if (!this.state.sectionCompletionDate) errors.sectionCompletionDate = "Can't be blank";
                ...
                <Header as="h4" color="green" textAlign="center">
                    ...
                    <Form size="large" onSubmit={this.onSubmit} loading={loading}>
                        ...
                        <Segment stacked>
                            ...
                            <DatePicker selected={this.state.sectionCompletionDate} onChange={this.handleCompletionDateChange} />
                            </Form.Field>
                            <Divider/>
                            <Form.Field error={!!errors.sectionLocation}>
                                ...
                                <input
                                    ...
                                    onChange={e => this.setState({ sectionLocation: e.target.value })}
                                                />
                            </Form.Field>
