...
class IssueSalaryCash extends Component {
          ...
          <Segment.Group horizontal>
            <Segment>
              ...
              <Table basic="very" celled>
                <Table.Body>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>
                      {initiatedSalaryRequest.payee.firstName} &nbsp; {initiatedSalaryRequest.payee.lastName}
                    </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>{initiatedSalaryRequest.amountRequested}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                  ...
                  <Table.Row>
                    ...
                    <Table.Cell>{moment(initiatedSalaryRequest.requestDate).format('MMM Do YYYY')} </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Date Approved </b>
                    </Table.Cell>
                    <Table.Cell>{moment(initiatedSalaryRequest.approvalDate).format('MMM Do YYYY')} </Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Other Details </b>
                    </Table.Cell>
                    <Table.Cell>{initiatedSalaryRequest.otherDetails}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                    <Table.Cell>
                      <b>Amount Issuing</b>
              ...
              <Button
                attached="bottom"
                positive
                onClick={() => this._issueCash(initiatedSalaryRequest.id, initiatedSalaryRequest.amountRequested)}
              >
                Issue Cash
              </Button>
            </Segment>
  ...
  _issueCash = async (requestId, amountIssued) => {
    ...
    await this.props.issuePayment({
      ...
      refetchQueries: [{ query: getUserDetails }, { query: ApprovedRequisitionsQuery }]
    });
