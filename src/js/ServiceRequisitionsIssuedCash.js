...
class ServiceRequisitionsIssuedCash extends Component {
	...
	render() {
		...
		if (
			this.props.requisitionFeed.issuedRequisitionsFeed === undefined ||
			this.props.requisitionFeed.issuedRequisitionsFeed === 0
		) {
						...
						return (
							<Table.Row>
								...
								<Table.Cell>
									{(() => {
										if (
											this.props.userDetails.me.role === 'ACCOUNTANT' &&
											request.paymentsDetails.cashReported === false
										) {
											return (
