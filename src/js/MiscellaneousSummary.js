...
class MiscellaneousSummary extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
    ...
    render() { 
        return (  
            ...
            Miscellaneous Expenses Report Summary
          </Header>
          <Divider color="olive"/>
          <Form>
          <Segment.Group horizontal>
            ...
            <hr color="pink"/> 
           <MiscellaneousExpenses startDate={moment(this.state.startDate).format('MMM DD YYYY')} endDate={moment(this.state.endDate).format('MMM DD YYYY')}/>
        </Fragment> 
        );
    }
}
 
export default MiscellaneousSummary;