							...
							<Table basic="very" celled>
								<Table.Body>
									<Table.Row>
										...
										<Table.Cell>
											{
												issuedFuelRequisition.requestedBy.personnelDetails
													.firstName
											}{' '}
											&nbsp;{' '}
											{
									...
									<Table.Row>
										...
										<Table.Cell>
											KES {issuedFuelRequisition.paymentsDetails.amountIssued}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
										...
										<Table.Cell>
											{
												issuedFuelRequisition.vehicleToBeFueled
													.registrationNumber
											}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										...
										<Table.Cell>
											{issuedFuelRequisition.otherDetails}
										</Table.Cell>
									</Table.Row>
								</Table.Body>
							</Table>
