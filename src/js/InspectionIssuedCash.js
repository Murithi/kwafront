...
class InspectionsIssuedCash extends Component {
	...
	render() {
		...
		if (
			this.props.requisitionFeed.issuedVehicleInspectionsFeed === undefined ||
			this.props.requisitionFeed.issuedVehicleInspectionsFeed === 0
		) {
		...
		return (
			<React.Fragment>
				...
				<Table celled selectable>
					...
					<Table.Body>
						{this.props.requisitionFeed.issuedVehicleInspectionsFeed.map(
							request => {
											...
											<Table.Cell>
												{(() => {
													if (this.props.userDetails.me.role === 'ACCOUNTANT') {
														return (
															<Link
																to={`/inspectionrequisitions/report/${
																	request.id
																}`}
															>
																Report Cash Usage
