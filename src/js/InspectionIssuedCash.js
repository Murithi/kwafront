...
class InspectionsIssuedCash extends Component {
    constructor(props) {
        super(props);
        this.state = {  }
    }
    render() { 
        ...
        if (this.props.requisitionFeed && this.props.requisitionFeed.loading) {
          ...
          if (this.props.requisitionFeed.issuedVehicleInspectionsFeed === undefined ||this.props.requisitionFeed.issuedVehicleInspectionsFeed === 0) {
            return <div>{emptyMessage}</div>;
          }
        return (
            <React.Fragment>
                <Header as="h4" color="green" textAlign="center">
                    Inspection Requisitions Issued Cash
                </Header>
                ...
                <Table.Row>
                    ...
                    {
                this.props.requisitionFeed.issuedVehicleInspectionsFeed.map(request => {
                  if (request.requestedInspectionPayment !== null) {
                    return (
                        ...
                        <Table.Cell>
                          {(() => {
                            ...
                            if (this.props.userDetails.me.role === 'ACCOUNTANT') {
                              return (
                                <Link to={`/inspectionrequisitions/report/${request.id}`}>
                                  Report Cash Usage
