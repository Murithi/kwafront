                    ...
                    <Segment.Group horizontal>
                        ...
                        <Divider />
                                <Table basic='very' celled >
                                            ...
                                            <Table.Cell>{issuedRepairsRequisition.requestedBy.personnelDetails.firstName} &nbsp; {issuedRepairsRequisition.requestedBy.personnelDetails.lastName}</Table.Cell>
                                                </Table.Row>
                                                <Table.Row>
                                        <Table.Cell><b>Amount Issued </b></Table.Cell>
                                        <Table.Cell>KES {issuedRepairsRequisition.paymentsDetails.amountIssued}</Table.Cell>
                                                </Table.Row> 
                                                <Table.Row>
                                        <Table.Cell><b>Vehicle Serviced </b></Table.Cell>
                                        <Table.Cell>{issuedRepairsRequisition.vehicleToBeRepaired.registrationNumber}</Table.Cell>
                                        </Table.Row>
                                                <Table.Row>
                                        <Table.Cell><b>Details </b></Table.Cell>
                                        <Table.Cell>{issuedRepairsRequisition.otherDetails}</Table.Cell>
                                        </Table.Row>        
                                            </Table.Body>
                                        </Table>   
                                        <Divider /> 
