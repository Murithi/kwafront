                    ...
                    <Divider />
                        <Table basic='very' celled >
                            ...
                            <Table.Row>
                                ...
                                <Table.Cell>{initiatedMiscellaneousRequisition.requestedBy.personnelDetails.firstName} &nbsp; {initiatedMiscellaneousRequisition.requestedBy.personnelDetails.lastName}</Table.Cell>
                                </Table.Row>  
                                <Table.Row>
                                <Table.Cell><b>Amount Requested </b></Table.Cell>
                                <Table.Cell>{initiatedMiscellaneousRequisition.amountRequested}</Table.Cell>
                                </Table.Row> 
                                <Table.Row>                                   
                               ...
                               <Table.Cell>
                                ...
                                <Table.Cell>{moment(initiatedMiscellaneousRequisition.requestDate).format('MMM Do YYYY')} </Table.Cell>
                                </Table.Row>
                                <Table.Row>
                                <Table.Cell><b>Date Approved </b></Table.Cell>
                                <Table.Cell>{moment(initiatedMiscellaneousRequisition.approvalDate).format('MMM Do YYYY')} </Table.Cell>
                                </Table.Row>
                                <Table.Row>
                                <Table.Cell><b>Other Details </b></Table.Cell>
                                <Table.Cell>{initiatedMiscellaneousRequisition.otherDetails}</Table.Cell>
                                </Table.Row>
                                <Table.Row>
                                    <Table.Cell><b>Amount Issuing</b></Table.Cell>
                                    <Table.Cell>
                                        <Input
                                        value={initiatedMiscellaneousRequisition.amountRequested}
