...
class UserDetails extends Component {
	...
	_updateUserRole = async () => {
		...
		if (authorized === null)
			return (authorized = this.props.userdetails.user.authorized)
	...
	render() {
		...
		if (
			this.props.userdetails.user === undefined ||
			this.props.userdetails.user === 0
		) {
				...
				<Grid.Column style={{ maxWidth: 900 }}>
					...
					<Segment.Group horizontal>
						<Segment>
							<p>
								<b>Employee:</b> &nbsp;&nbsp;&nbsp;{' '}
								{this.props.userdetails.user.personnelDetails.firstName} &nbsp;{' '}
							...
							<p>
								<b>User Email:</b> &nbsp;&nbsp;&nbsp;{' '}
								{this.props.userdetails.user.email}
							</p>
							<Divider />
							<p>
								<b>Locked:</b> &nbsp;&nbsp;&nbsp;{' '}
