        ...
        <Table celled selectable>
          ...
          <Table.Body>
            {this.props.VehicleFeed.vehicleFeed.map(Vehicle => (
              <Table.Row>
                <Table.Cell>
                  <Link to={`/vehicles/${Vehicle.id}`}>{Vehicle.registrationNumber}</Link>
                </Table.Cell>
                <Table.Cell>{Vehicle.model}</Table.Cell>

                <Table.Cell>
                  <Link to={`/vehicleowner/${Vehicle.owner.id}`}>{Vehicle.owner.name}</Link>
                </Table.Cell>
                <Table.Cell>
                ...
                <Table.Cell>
                  <Icon onClick={() => this._deleteVehicle(Vehicle.id)} name="delete circle red" />
                </Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
