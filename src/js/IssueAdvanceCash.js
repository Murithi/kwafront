							...
							<Table basic="very" celled>
								<Table.Body>
									...
									<Table.Row>
										...
										<Table.Cell>
											{
												initiatedAdvanceRequest.requestedBy.personnelDetails
													.firstName
											}{' '}
											&nbsp;{' '}
											{
									...
									<Table.Row>
										...
										<Table.Cell>
											{moment(initiatedAdvanceRequest.approvalDate).format(
												'MMM Do YYYY',
											)}{' '}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										...
										<Table.Cell>
											{initiatedAdvanceRequest.otherDetails}
										</Table.Cell>
									</Table.Row>
									<Table.Row>
										<Table.Cell>
